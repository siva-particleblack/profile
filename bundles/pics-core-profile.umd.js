(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var ProfileComponent$1 = /** @class */ (function () {
        function ProfileComponent(injector, authService, formBuilder, httpService, profileService, attachmentService, _storeservice, confirmationService) {
        ...
        ProfileComponent.prototype.removeThumbnail = function (event) {
            ...
            this.confirmationService.confirm({
                ...
                accept: function () {
                    _this.thumbnail = '';
                    _this.alertService.success('Profile removed successfully.');
                },
                reject: function () {
                    // reject message
                }
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: ProfileComponent$1, decorators: [{
            ...
            }], ctorParameters: function () { return [{ type: i0__namespace.Injector }, { type: AuthService }, { type: i2__namespace.FormBuilder }, { type: HttpService }, { type: ProfileService }, { type: AttachmentsService }, { type: DataStoreService }, { type: i7__namespace.ConfirmationService }]; } });
    ...
    PicsProfileModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: PicsProfileModule, declarations: [ProfileComponent$1], imports: [i11.CommonModule,
            i2.FormsModule,
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: ProfileSettingsModule, decorators: [{
                ...
                args: [{
                        ...
                        providers: [ProfileService, AttachmentsService, i1.HttpClient, HttpService, AlertService, AuthService, i7.ConfirmationService, PermissionStore, DataStoreService]
                    }]
            }] });
