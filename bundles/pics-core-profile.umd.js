(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var ProfileComponent$1 = /** @class */ (function () {
        function ProfileComponent(injector, authService, formBuilder, profileService, attachmentService, _storeservice, confirmationService, profileUpdateService, router, navigationAlertService) {
            ...
            this.orgSubs = this._storeservice.currentStore.subscribe(function (res) {
                if (res['RBACORG'] && res['RBACORG'] !== '') {
                    ...
                    if (_this.environment) {
                        ...
                        _this.fontSlider();
                        _this.getUserTheme();
                        var tab = _this.localstorage.getItem('CURRENT_PROFILE_TAB');
                        _this.getTab(tab);
                    }
                }
            });
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: ProfileComponent$1, decorators: [{
            ...
            }], ctorParameters: function () { return [{ type: i0__namespace.Injector }, { type: AuthService }, { type: i2__namespace.FormBuilder }, { type: ProfileService }, { type: AttachmentsService }, { type: DataStoreService }, { type: i6__namespace.ConfirmationService }, { type: ProfileUpdateService }, { type: i1__namespace.Router }, { type: NavigationAlertService }]; } });
