(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var ProfileComponent$1 = /** @class */ (function () {
        function ProfileComponent(injector, authService, formBuilder, profileService, attachmentService, _storeservice, confirmationService, profileUpdateService, router) {
        ...
        ProfileComponent.prototype.ngOnInit = function () {
            ...
            this.router.events.subscribe(function (event) {
                if (event instanceof i1.NavigationStart && _this.showAlert) {
        ...
        ProfileComponent.prototype.updateprofile = function () {
            ...
            this.profileService.updateUser(userData, this.userid).subscribe(function () {
                ...
                _this.profileUpdateService.updateProfilePicture(_this.thumbnail);
            });
        };
    ...
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: ProfileComponent$1, decorators: [{
            ...
            }], ctorParameters: function () { return [{ type: i0__namespace.Injector }, { type: AuthService }, { type: i2__namespace.FormBuilder }, { type: ProfileService }, { type: AttachmentsService }, { type: DataStoreService }, { type: i6__namespace.ConfirmationService }, { type: ProfileUpdateService }, { type: i1__namespace.Router }]; } });
    ...
    NavigationAlertService.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: NavigationAlertService, deps: [{ token: i1__namespace.Router }], target: i0__namespace.ɵɵFactoryTarget.Injectable });
    NavigationAlertService.ɵprov = i0__namespace.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: NavigationAlertService, providedIn: 'root' });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: NavigationAlertService, decorators: [{
                type: i0.Injectable,
                args: [{
                        providedIn: 'root'
                    }]
    ...
    ProfileSettingsModule.ɵinj = i0__namespace.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: ProfileSettingsModule, providers: [ProfileService, ProfileUpdateService, AttachmentsService, http.HttpClient, AlertService, AuthService, i6.ConfirmationService, PermissionStore, DataStoreService, NavigationAlertService], imports: [[
                PicsProfileModule
            ]] });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0__namespace, type: ProfileSettingsModule, decorators: [{
                ...
                args: [{
                        ...
                        providers: [ProfileService, ProfileUpdateService, AttachmentsService, http.HttpClient, AlertService, AuthService, i6.ConfirmationService, PermissionStore, DataStoreService, NavigationAlertService]
                    }]
            }] });
