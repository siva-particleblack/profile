...
import { Injectable, Component, HostListener, Input, Directive, NgModule, NO_ERRORS_SCHEMA, CUSTOM_ELEMENTS_SCHEMA } from '@angular/core';
...
class ProfileComponent$1 {
    constructor(injector, authService, formBuilder, profileService, attachmentService, _storeservice, confirmationService, profileUpdateService, router) {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0, type: ProfileComponent$1, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: i0.Injector }, { type: AuthService }, { type: i2.FormBuilder }, { type: ProfileService }, { type: AttachmentsService }, { type: DataStoreService }, { type: i6.ConfirmationService }, { type: ProfileUpdateService }, { type: i1.Router }]; }, propDecorators: { unloadNotification: [{
                type: HostListener,
