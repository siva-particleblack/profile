...
class ProfileComponent$1 {
    constructor(injector, authService, formBuilder, httpService, profileService, profileUpdateService, attachmentService, _storeservice, confirmationService) {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0, type: ProfileComponent$1, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: i0.Injector }, { type: AuthService }, { type: i2.FormBuilder }, { type: HttpService }, { type: ProfileService }, { type: ProfileUpdateService }, { type: AttachmentsService }, { type: DataStoreService }, { type: i8.ConfirmationService }]; } });
