...
class ProfileComponent$1 {
    ...
    ngOnInit() {
        ...
        this.router.events.subscribe(event => {
            if (event instanceof NavigationStart && this.showAlert) {
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.2.17", ngImport: i0, type: ProfileComponent$1, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: i0.Injector }, { type: AuthService }, { type: i2.FormBuilder }, { type: ProfileService }, { type: AttachmentsService }, { type: DataStoreService }, { type: i6.ConfirmationService }, { type: ProfileUpdateService }, { type: i1.Router }]; } });
